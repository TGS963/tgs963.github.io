...
export default function Home() {
  return (
    <main className={`flex justify-between min-h-screen flex-col items-center p-12 ${inter.className} dark:bg-black bg-green-200/50 dark:text-green-200 text-green-500`}>
      <Stars />
      {/* Main Content Start */}
      ...
      <Card customClassName="">
        ...
        <a href="https://boostbot.ai" className="p-4 bg-gradient-to-r from-green-300/30 via-green-100 to-green-300/30 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105">
          <img src="/boostbot.png" alt="Boostbot.ai" className="w-16 h-16 rounded-full object-cover mb-2"/>
          <p className="text-lg frutiger-metallic-text font-semibold">Software Engineer at Boostbot.ai</p>
          <p className="text-sm frutiger-metallic-text">I built an email client, deployed cloud infrastructure, and created reactive UIs.</p>
        </a>
        <a href="https://outlandishdigital.us/home" className="p-4 bg-gradient-to-r from-green-300/30 via-green-100 to-green-300/30 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105">
          <img src="/outlandish.png" alt="Outlandish Digital" className="w-16 h-16 rounded-full object-cover mb-2"/>
          <p className="text-lg frutiger-metallic-text font-semibold">Software Engineer at Outlandish Digital</p>
          <p className="text-sm frutiger-metallic-text">I led development of data pipelines and APIs, driving performance gains and scalability.</p>
        </a>
        </section>
      </Card>
      </section>
